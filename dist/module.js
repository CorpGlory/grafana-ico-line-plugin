define(["lodash","moment","jquery","app/plugins/sdk","app/core/app_events"], function(__WEBPACK_EXTERNAL_MODULE_172__, __WEBPACK_EXTERNAL_MODULE_470__, __WEBPACK_EXTERNAL_MODULE_471__, __WEBPACK_EXTERNAL_MODULE_472__, __WEBPACK_EXTERNAL_MODULE_473__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__clip_antimeridian__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__clip_circle__ = __webpack_require__(340);
...
exports.WIND_DIRECTIONS_COUNT = 16;
...
(function (WindDirection) {
    ...
    WindDirection[WindDirection["NNE"] = 1] = "NNE";
    WindDirection[WindDirection["NE"] = 2] = "NE";
    WindDirection[WindDirection["ENE"] = 3] = "ENE";
    WindDirection[WindDirection["E"] = 4] = "E";
    WindDirection[WindDirection["ESE"] = 5] = "ESE";
    WindDirection[WindDirection["SE"] = 6] = "SE";
    WindDirection[WindDirection["SSE"] = 7] = "SSE";
    WindDirection[WindDirection["S"] = 8] = "S";
    WindDirection[WindDirection["SSW"] = 9] = "SSW";
    WindDirection[WindDirection["SW"] = 10] = "SW";
    WindDirection[WindDirection["WSW"] = 11] = "WSW";
    WindDirection[WindDirection["W"] = 12] = "W";
    WindDirection[WindDirection["WNW"] = 13] = "WNW";
    WindDirection[WindDirection["NW"] = 14] = "NW";
    WindDirection[WindDirection["NNW"] = 15] = "NNW";
...
exports.WIND_SPEED_SCALES = [0, 1, 4, 8, 13, 18, 25, 31, 39, 47, 55, 64, 73].map(function (m) {
    return m * 0.44704;
});

var WindPoint = function WindPoint(timestamp, direction, speed) {
    _classCallCheck(this, WindPoint);
...
exports.WindPoint = WindPoint;

var WindPointSet = function () {
    function WindPointSet(points) {
        _classCallCheck(this, WindPointSet);

        this._points = points;
    }

    _createClass(WindPointSet, [{
        key: "findPoint",
        value: function findPoint(timestamp) {
        ...
        key: "getMaxSpeedLimit",
        value: function getMaxSpeedLimit() {
            return _.max(this._points.map(function (s) {
                return s.speed;
            }));
        }
    }, {
...
exports.WindPointSet = WindPointSet;

var WeatherPoint = function WeatherPoint(timestamp, id) {
    _classCallCheck(this, WeatherPoint);
...
exports.WeatherPoint = WeatherPoint;

var WeatherPointSet = function () {
    function WeatherPointSet(points) {
        _classCallCheck(this, WeatherPointSet);

        this._points = points;
    }

    _createClass(WeatherPointSet, [{
        key: "findPoint",
        value: function findPoint(timestamp) {
            var minDist = Number.POSITIVE_INFINITY;
            var res = undefined;
    ...
    return WeatherPointSet;
}();

exports.WeatherPointSet = WeatherPointSet;

var WeatherSeries = function WeatherSeries() {
    _classCallCheck(this, WeatherSeries);

    this.windPoints = new WindPointSet([]);
    this.weatherPoints = new WeatherPointSet([]);
};

exports.WeatherSeries = WeatherSeries;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__polygon__ = __webpack_require__(133);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__polygon__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__math__ = __webpack_require__(0);
...
Object.defineProperty(exports, "__esModule", { value: true });
var module_config_1 = __webpack_require__(92);
var graph_1 = __webpack_require__(174);
var render_config_1 = __webpack_require__(467);
var series_mapper_1 = __webpack_require__(468);
var tooltip_1 = __webpack_require__(469);
var sdk_1 = __webpack_require__(472);
var app_events_1 = __webpack_require__(473);
...
var Ctrl = function (_sdk_1$MetricsPanelCt) {
    ...
    _createClass(Ctrl, [{
        ...
        value: function _onInitEditMode() {
            ...
            this.addEditorTab('Editor', thisPartialPath + 'editor.mapping.html', 2);
        }
    }]);
...
Object.defineProperty(exports, "__esModule", { value: true });
var wind_points_1 = __webpack_require__(175);
var weather_points_1 = __webpack_require__(474);
var grid_1 = __webpack_require__(465);
var crosshair_1 = __webpack_require__(466);
var d3 = __webpack_require__(33);
var MARGIN = { top: 60, right: 30, bottom: 20, left: 30 };

var Graph = function () {
    function Graph(element, renderConfig) {
        ...
        this._initCanvas();
        this._initBack();
        this._grid = new grid_1.Grid(this._canvas, this._renderConfig);
        this._windPoints = new wind_points_1.WindPoints(this._canvas, this._renderConfig);
        this._weatherPoints = new weather_points_1.WeatherPoints(this._canvas, this._renderConfig);
        this._crossHair = new crosshair_1.Crosshair(this._canvas, this._renderConfig);
    }
    ...
    _createClass(Graph, [{
        ...
        key: "showCrosshair",
        value: function showCrosshair(timestamp) {
        ...
        key: "_initBack",
        value: function _initBack() {
            this._back = this._canvas.append('rect');
            this._back.attr('x', 0).attr('y', 0).attr('fill', 'rgba(255,255,255,0)');
        }
    }, {
        key: "_renderBack",
        ...
        value: function _updateDimensions() {
            ...
            if (newWidth === this._renderConfig.width && newHeight === this._renderConfig.height) {
                return;
            }
        ...
        value: function _initCanvas() {
            ...
            this._canvas.on("mousemove", this._onMouseMove.bind(this)).on("mouseout", this._onMouseOut.bind(this));
        }
    }, {
        key: "_onMouseMove",
        value: function _onMouseMove() {
            var _d3$mouse = d3.mouse(this._canvas.node()),
...
Object.defineProperty(exports, "__esModule", { value: true });
var d3 = __webpack_require__(33);
var weather_series_1 = __webpack_require__(48);
var WIND_SPEED_COLORS = ['#FFFFFF', '#CCFFFF', '#99FFCC', '#99FF99', '#99FF66', '#99FF00', '#CCFF00', '#FFFF00', '#FFCC00', '#FF9900', '#FF6600', '#FF3300', '#FF0000'];

var WindPoints = function () {
    function WindPoints(canvas, renderConfig) {
        _classCallCheck(this, WindPoints);

        this._renderConfig = renderConfig;
        this._g = canvas.append('g');
        this._g.classed('gwindPoints', true);
        this._windColorScale = d3.scaleLinear().domain(weather_series_1.WIND_SPEED_SCALES).range(WIND_SPEED_COLORS).clamp(true);
    }

    _createClass(WindPoints, [{
        key: "setData",
        ...
        value: function render() {
            ...
            this._g.selectAll('.arrowG').data(this._points.points).attr('transform', function (d) {
                ...
                return res;
            }).select('polygon').attr('fill', function (d) {
                return _this._windColorScale(d.speed);
            });
        }
    }]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_simulation__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_x__ = __webpack_require__(314);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_y__ = __webpack_require__(315);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_contains__ = __webpack_require__(330);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_distance__ = __webpack_require__(136);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_graticule__ = __webpack_require__(331);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_interpolate__ = __webpack_require__(332);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_length__ = __webpack_require__(137);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_path_index__ = __webpack_require__(333);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_projection_albers__ = __webpack_require__(139);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_projection_albersUsa__ = __webpack_require__(343);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_projection_azimuthalEqualArea__ = __webpack_require__(344);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_projection_azimuthalEquidistant__ = __webpack_require__(345);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_projection_conicConformal__ = __webpack_require__(346);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_projection_conicEquidistant__ = __webpack_require__(347);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__src_projection_equirectangular__ = __webpack_require__(141);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__src_projection_gnomonic__ = __webpack_require__(348);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__src_projection_identity__ = __webpack_require__(349);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__src_projection_orthographic__ = __webpack_require__(350);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__src_projection_stereographic__ = __webpack_require__(351);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__src_projection_transverseMercator__ = __webpack_require__(352);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__math__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__index__ = __webpack_require__(140);
...
var Grid = function () {
    function Grid(canvas, renderConfig) {
    ...
    _createClass(Grid, [{
        ...
        value: function render() {
            ...
            this._gTime.attr("transform", "translate(0," + this._renderConfig.height + ")").call(d3.axisBottom(this._renderConfig.scaleTime));
            this._gValue.call(d3.axisLeft(this._renderConfig.scaleValue));
            this._gGridValue.selectAll().remove();
            var gridlinesV = d3.axisBottom(this._renderConfig.scaleTime).tickSize(this._renderConfig.height).tickFormat(function () {
                return '';
            });
            var gridlinesH = d3.axisLeft(this._renderConfig.scaleValue).tickSize(-this._renderConfig.width).tickFormat(function () {
                return '';
            });
...
var Crosshair = function () {
    function Crosshair(canvas, renderConfig) {
...
var d3 = __webpack_require__(33);
var weather_series_1 = __webpack_require__(48);
var DEFAULT_VALUE_LIMIT = weather_series_1.WIND_SPEED_SCALES[Math.floor(weather_series_1.WIND_SPEED_SCALES.length / 2)];

var RenderConfig = function () {
    function RenderConfig() {
        _classCallCheck(this, RenderConfig);

        this.scaleTime = d3.scaleTime();
        this.scaleValue = d3.scaleLinear().domain([0, DEFAULT_VALUE_LIMIT]);
        this.graphX = 0;
        this.graphY = 0;
    }

    _createClass(RenderConfig, [{
        key: "stop",
...
var weather_series_1 = __webpack_require__(48);
var _ = __webpack_require__(172);
var DEFAULT_MAPPING = function DEFAULT_MAPPING(seriesListItem) {
    /*
    Should return:
    {
      windPoints: [[
    ...
    */
    ...
    var WIND_TIME_STEP = 100 * 60 * 1000; // 100 minutes
    var WEATHER_ID_COUNT = 47;
...
function getDefaultSource() {
    return (DEFAULT_MAPPING + "$").replace('function DEFAULT_MAPPING(', 'function(').replace(new RegExp('    ', 'g'), '  ').replace('}$', '}');
}
exports.getDefaultSource = getDefaultSource;

var SeriesMapper = function () {
    function SeriesMapper() {
        _classCallCheck(this, SeriesMapper);

        this._update();
    }

    _createClass(SeriesMapper, [{
        key: "map",
        value: function map(seriesListItem) {
            if (seriesListItem === undefined) {
                throw new Error('Trying to pass undefined seriesListItem');
            }
            var rawData = this._mappingFunction(seriesListItem);
            var weatherSeries = new weather_series_1.WeatherSeries();
            weatherSeries.windPoints.points = _.map(rawData.windPoints, function (_ref) {
                var _ref2 = _slicedToArray(_ref, 3),
                    t = _ref2[0],
                    d = _ref2[1],
                    s = _ref2[2];

                return new weather_series_1.WindPoint(t, d, s);
            });
            weatherSeries.weatherPoints.points = _.map(rawData.weatherPoints, function (_ref3) {
                var _ref4 = _slicedToArray(_ref3, 2),
                    t = _ref4[0],
                    d = _ref4[1];

                return new weather_series_1.WeatherPoint(t, d);
            });
        ...
        get: function get() {
            var cres = module_config_1.ModuleConfig.getInstance().getValue('mappingFunctionSource');
            var res = cres !== undefined ? cres : getDefaultSource();
            return res;
        },
        set: function set(value) {
            module_config_1.ModuleConfig.getInstance().setValue('mappingFunctionSource', value);
            this._update();
        }
    }]);
...
var $ = __webpack_require__(471);
var weather_series_1 = __webpack_require__(48);

var Tooltip = function () {
    function Tooltip(dashboard, renderConfig) {
    ...
    _createClass(Tooltip, [{
        key: "show",
        value: function show(timestamp, panelRelY, windPoint) {
            ...
            html += "\n      Direction: " + weather_series_1.WindDirection[windPoint.direction] + " <br/>\n      Speed: " + Math.round(windPoint.speed * 100) / 100 + "\n    ";
        ...
        value: function _getCurrentTimeFormatted(timestamp) {
...
module.exports = __WEBPACK_EXTERNAL_MODULE_470__;

/***/ }),
/* 471 */
/***/ (function(module, exports) {

module.exports = __WEBPACK_EXTERNAL_MODULE_471__;

/***/ }),
/* 472 */
/***/ (function(module, exports) {

module.exports = __WEBPACK_EXTERNAL_MODULE_472__;
...
var WeatherPoints = function () {
    function WeatherPoints(canvas, renderConfig) {
        _classCallCheck(this, WeatherPoints);
    ...
    _createClass(WeatherPoints, [{
        ...
        value: function render() {
            ...
            items.exit().remove();
            this._g.selectAll('.wIco').data(this._points.points).attr('transform', function (d) {
                var x = _this._renderConfig.scaleTime(d.timestamp);
                var y = 0;
                var res = "";
                res += "translate(" + x + ", " + y + ")";
...
exports.WeatherPoints = WeatherPoints;
